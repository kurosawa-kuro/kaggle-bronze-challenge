...
ただし、**現在コードで実体化済みなのは Custom Job / Hyperparameter Tuning / GCS / Artifact Registry / BigQuery ログ・コスト記録**である。Model Registry / Pipelines / Endpoint / Monitoring は ADR 上の拡張候補であり、この文書では実装済み機能として扱わない。
